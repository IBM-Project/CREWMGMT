                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            ...
                            <a href="#">
                                ...
                                out.println(" Your "+test+ " training has been completed");
                                }
                                catch(Exception e)
                                {
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="user-info">
                                <div><strong><%out.println(session.getAttribute("crewsession"));  %></strong></div>
                    ...
                    <li class="selected">
                        <a href="Crew.html"><i class="fa fa-dashboard fa-fw"></i>Crew Homepage</a>
                    </li>
                     <li>
                        <a href="Addtraining.jsp"><i class="fa fa-flask fa-fw"></i>Enroll For Training</a>
                    </li>
                    <li>
                        <a href="ViewTrain.jsp"><i class="fa fa-table fa-fw"></i>View Done Training</a>
                    </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-folder-open"></i><b>&nbsp;Hello ! </b>Welcome Back <b><%out.println(session.getAttribute("crewsession"));%></b>
